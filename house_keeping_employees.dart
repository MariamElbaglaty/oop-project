...
import 'work.dart';
class House_keeping_employees implements Employees{

employee b=employee(0, '',0, '', '');
House_keeping_employees()
{
  {
...
employee id_old=employee.e.firstWhere((element) => element.id==id,orElse: () =>b);
bool ids=id_old==b;
